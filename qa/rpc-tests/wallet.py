...
#   c) node1 mines 32 blocks, so now node 0 has 60001ntx, node 1 has 4250ntx, node2 has none.
#   d) node0 sends 601 ntx to node2, in two transactions (301 ntx, then 300 ntx).
