...
RESOURCES += src/qt/netchain.qrc src/qt/netchain_locale.qrc

TRANSLATIONS += src/qt/locale/netchain_bg.ts \
                src/qt/locale/netchain_de.ts \
                src/qt/locale/netchain_en.ts \
                src/qt/locale/netchain_es.ts \
                src/qt/locale/netchain_fi.ts \
                src/qt/locale/netchain_fr.ts \
                src/qt/locale/netchain_it.ts \
                src/qt/locale/netchain_ja.ts \
                src/qt/locale/netchain_pl.ts \
                src/qt/locale/netchain_pt.ts \
                src/qt/locale/netchain_ru.ts \
                src/qt/locale/netchain_sk.ts \
                src/qt/locale/netchain_sv.ts \
                src/qt/locale/netchain_vi.ts \
                src/qt/locale/netchain_zh_CN.ts \
                src/qt/locale/netchain_zh_TW.ts
