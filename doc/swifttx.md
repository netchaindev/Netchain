...
This mechanism has been integrated into Bitcore-Node-Netchain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Netchain-Project/insight-api-netchain#web-socket-api](https://github.com/Netchain-Project/insight-api-netchain#web-socket-api) 
* API: [https://github.com/Netchain-Project/insight-api-netchain#swifttx-transactions](https://github.com/Netchain-Project/insight-api-netchain#swifttx-transactions) 
...
By default, the Netchain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Netchain Core daemon:
