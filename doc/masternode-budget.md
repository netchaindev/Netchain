...
Netchain now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<netchain_address\> \<monthly_payment_netchain\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Netchain, _12_ times over the course of a year totaling _24000_ Netchain.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<netchain_address\> \<monthly_payment_netchain\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Netchain.
