...
In order to support loading of multiple wallets in netchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is netchain.cpp.
...
Changes to netchain.cpp
----------------------
netchain.cpp is the entry point into netchain-qt, and as such, will require some minor modifications to provide hooks for
