Contributing to Netchain Core
============================

The Netchain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Netchain Core project, and is not to be
confused with overall Netchain Network Protocol consensus changes.

Whether a pull request is merged into Netchain Core rests with the project merge
...
Patches that change Netchain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Netchain consensus, it must have been
...
The project leader is the release manager for each Netchain Core release.
