...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Netchain Core"),
     ...
     * override -datadir in the netchain.conf file in the default data directory
     * (to be consistent with netchaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
