...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zntxTracker->HasMintTx(hash))) {
            //zNTX stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZNTX;
...
bool IsZNTXType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZNTX:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZNTX || type == TransactionRecord::MNReward) {
