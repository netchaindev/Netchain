...
/** Utility functions used by the Netchain Qt UI.
 */
namespace GUIUtil
{
...
// Render Netchain addresses in monospace font
...
// Parse "netchain:" URI into recipient object, return true on successful parsing
