                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNTXPathCustom = GetArg("-zntxbackuppath", "");
    ...
    if(!strzNTXPathCustom.empty()) {
        ui->wallet_customzntxbackuppath->setText(QString::fromStdString(strzNTXPathCustom));
        ui->wallet_customzntxbackuppath_label->setVisible(true);
        ui->wallet_customzntxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNTXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Netchain RPC console.") + "<br>" +
