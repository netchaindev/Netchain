                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Netchain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Netchain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and netchain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNTX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Netchain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Netchain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Netchain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Netchain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Netchain addresses"));
    ...
    openAction->setStatusTip(tr("Open a Netchain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Netchain Core help message to get a list with possible Netchain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Netchain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Netchain network", "", count));
}
...
{
    QString strTitle = tr("Netchain Core"); // default title
