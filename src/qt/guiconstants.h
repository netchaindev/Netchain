...
/* Netchain GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Netchain"
#define QAPP_ORG_DOMAIN "netchain.org"
#define QAPP_APP_NAME_DEFAULT "Netchain-Qt"
#define QAPP_APP_NAME_TESTNET "Netchain-Qt-testnet"
