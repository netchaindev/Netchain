...
#ifndef Netchain_STAKEINPUT_H
#define Netchain_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZNTX() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zNTXStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zntx, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZNTX() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZNTX() override { return false; }
};


#endif //Netchain_STAKEINPUT_H
