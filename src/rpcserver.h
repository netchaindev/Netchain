...
/**
 * Netchain RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzntxseed(const UniValue& params, bool fHelp);
extern UniValue getzntxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzntx(const UniValue& params, bool fHelp);
extern UniValue dzntxstate(const UniValue& params, bool fHelp);
