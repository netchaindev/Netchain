...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Netchain server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Netchain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Netchain features */
        {"netchain", "masternode", &masternode, true, true, false},
        {"netchain", "listmasternodes", &listmasternodes, true, true, false},
        {"netchain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"netchain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"netchain", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"netchain", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"netchain", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"netchain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"netchain", "masternodedebug", &masternodedebug, true, true, false},
        {"netchain", "startmasternode", &startmasternode, true, true, false},
        {"netchain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"netchain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"netchain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"netchain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"netchain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"netchain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"netchain", "mnbudget", &mnbudget, true, true, false},
        {"netchain", "preparebudget", &preparebudget, true, true, false},
        {"netchain", "submitbudget", &submitbudget, true, true, false},
        {"netchain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"netchain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"netchain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"netchain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"netchain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"netchain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"netchain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"netchain", "checkbudgets", &checkbudgets, true, true, false},
        {"netchain", "mnsync", &mnsync, true, true, false},
        {"netchain", "spork", &spork, true, true, false},
        {"netchain", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzntxseed", &getzntxseed, false, false, true},
        {"zerocoin", "setzntxseed", &setzntxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzntx", &searchdzntx, false, false, true},
        {"zerocoin", "dzntxstate", &dzntxstate, false, false, true}
...
{
    return "> netchain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7815/\n";
}
