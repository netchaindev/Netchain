/* src/config/netchain-config.h.  Generated from netchain-config.h.in by configure.  */
/* src/config/netchain-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.netchain.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Netchain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Netchain Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "netchain"
